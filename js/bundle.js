...
var __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_RESULT__ = (function () {
  var FORM_AJAX_CLASS = '.js-form-ajax';
  var AJAX = true;

  var formSubmit = function formSubmit($form, callback) {
    var params = getFormParams($form);
    sendForm($form, params, callback);
  };

  var sendForm = function sendForm(form, params, callback) {
  ...
  var getFormParams = function getFormParams(form) {
  ...
  var namelessInput = function namelessInput(input) {
    return input.name === '';
  };

  var disabledInput = function disabledInput(input) {
    return input.disabled === true;
  };

  var uncheckedInput = function uncheckedInput(input) {
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! ./form-ajax.js */ "./src/js/form-ajax.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (formAjax) {
  var FORM_CLASS = '.js-form';
  var FORM_SUBMIT_CLASS = '.js-form-submit';
  var INPUT_CLASS_SUCCESS = 'is-valid';
  var INPUT_CLASS_ERROR = 'is-invalid';
  var INPUT_CAPTCHA_NAME = 'g-recaptcha-response';
  var buttonList;
  ...
  var onSubmit = function onSubmit(e) {
    e.preventDefault();
    var $form = e.target.closest(FORM_CLASS);
    var inputList = $form.elements;
    loading($form, true);
  ...
  var formCallback = function formCallback(form, status) {
    loading(form, false);
  ...
  var loading = function loading(form, state) {
    var $submit = form.querySelector('.js-form-submit');
    var attr = state === true ? 'on' : 'off';
    $submit.innerHTML = $submit.getAttribute('data-' + attr);
    $submit.classList.toggle('is-loading');
  };

  var toggleMessage = function toggleMessage(form, type) {
    var $messageList = form.querySelectorAll('.js-form-feedback');
  ...
  var filterInput = function filterInput(list) {
  ...
  var toggleClass = function toggleClass(input, add, remove) {
    input.classList.add(add);
    input.classList.remove(remove);
  };

  var validateSelect = function validateSelect(input) {
    var classToAdd = input.selectedIndex === 0 ? INPUT_CLASS_ERROR : INPUT_CLASS_SUCCESS;
    var classToRemove = input.selectedIndex === 0 ? INPUT_CLASS_SUCCESS : INPUT_CLASS_ERROR;
    toggleClass(input, classToAdd, classToRemove);
  };

  var validateTextArea = function validateTextArea(input) {
    validateText(input);
  };

  var validateCheckboxRadio = function validateCheckboxRadio(input, list) {
    var name = input.name;
    var siblingList = getSibling(name, list);
    var hasChecked = false;
    var classToAdd, classToRemove;

    for (var i = siblingList.length - 1; i >= 0; i--) {
      var $input = siblingList[i];
  ...
  var validateText = function validateText(input) {
    var val = input.value;
    var classToAdd = val === '' ? INPUT_CLASS_ERROR : INPUT_CLASS_SUCCESS;
    var classToRemove = val === '' ? INPUT_CLASS_SUCCESS : INPUT_CLASS_ERROR;
    toggleClass(input, classToAdd, classToRemove);
  };

  var getInputType = function getInputType(input) {
    if (input.nodeName === 'SELECT') {
      return 'select';
  ...
  var getSibling = function getSibling(name, list) {
    var siblingList = [];
  ...
  var inputIsText = function inputIsText(type) {
    return type === 'text' || type === 'number' || type === 'tel';
  };

  var inputIsEmail = function inputIsEmail(type) {
    return type === 'email';
  };

  var inputIsSelect = function inputIsSelect(type) {
    return type === 'select';
  };

  var inputIsCaptcha = function inputIsCaptcha(type) {
    return type === INPUT_CAPTCHA_NAME;
  };

  var inputIsTextArea = function inputIsTextArea(type) {
    return type === 'textarea';
  };

  var inputIsCheckboxRadio = function inputIsCheckboxRadio(type) {
...
var webfont = __webpack_require__(/*! ./webfont.js */ "./src/js/webfont.js");

webfont.init(['PT Sans', 'fontello'], ['/css/font.css']);

__webpack_require__(/*! ./scroll.js */ "./src/js/scroll.js");

__webpack_require__(/*! ./nav.js */ "./src/js/nav.js");

__webpack_require__(/*! ./trailer.js */ "./src/js/trailer.js");
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! smoothscroll-polyfill */ "./node_modules/smoothscroll-polyfill/dist/smoothscroll.js"), __webpack_require__(/*! ./fittext.js */ "./src/js/fittext.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (smoothscroll) {
  ...
  **/
  ...
  var init = function init() {
    ...
    listen();
    window.fitText(document.querySelector('.js-title'), 0.8, {
      minFontSize: 60
    });
    window.fitText(document.querySelector('.js-subtitle'), 2, {
      minFontSize: 20,
      maxFontSize: 40
    });
  };
  ...
  **/
  ...
  var listen = function listen() {
    var $navLinkList = document.querySelectorAll(NAV_SCROLL_CLASS);
  ...
  **/
  ...
  var toggleNavXS = function toggleNavXS(e) {
  ...
  **/
  ...
  var onClickNav = function onClickNav(e) {
    var anchor = getAnchor(e.currentTarget.href);
    window.scroll({
  ...
  **/
  ...
  var getAnchor = function getAnchor(str) {
...
var __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_RESULT__ = (function () {
  ...
  var listen = function listen() {
    ...
    document.addEventListener('scroll', function () {
      ...
      setTimeout(function () {
        waiting = false;
      }, 100); // schedule an extra execution of scroll() after 200ms
...
var __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_RESULT__ = (function () {
  var TOGGLE_CLASS = '.js-trailer-toggle';
  var CONTAINER_CLASS = '.js-trailer';
  ...
  **/
  ...
  var listen = function listen() {
    var $toggleList = document.querySelectorAll(TOGGLE_CLASS);
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! webfontloader */ "./node_modules/webfontloader/webfontloader.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (WebFont) {
  var init = function init(families, urls) {
    WebFont.load({
      custom: {
        families: families,
        urls: urls
